    ...
    <div class="sm:flex sm:items-center">
      <div class="sm:flex-auto">
        ...
        <p class="mt-2 text-sm text-gray-700">
          Una lista de todos los usuarios de su cuenta incluyendo su nombre, cargo,
          correo electrónico.
        </p>
      </div>
        ...
        <div class="inline-block min-w-full py-2 align-middle sm:px-6 lg:px-8">
          <table class="min-w-full divide-y divide-gray-300">
            ...
            <tbody class="divide-y divide-gray-200 bg-white">
              <tr
                v-for="MilitaryUser in MilitaryUsers"
                :key="MilitaryUser.email"
              >
                ...
                >
                  <a href="#" class="text-indigo-600 hover:text-CerberusDarkBlue-default"
                    >Edit<span class="sr-only"
                      >, {{ MilitaryUser.name }}</span
                    ></a
                  >
                </td>
              </tr>
